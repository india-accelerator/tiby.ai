const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Tiby account',
    langGeniusAccountTip: 'Your Tiby account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Tiby to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Tiby allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Tiby\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Tiby {{version}} is now available.',
    latestAvailable: 'Tiby {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
