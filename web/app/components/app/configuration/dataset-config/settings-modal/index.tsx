      ...
      <div className='p-6 pt-5 border-b overflow-y-auto pb-[68px]' style={{
        ...
        <div className={cn(rowClass)}>
          ...
          <div className='w-full'>
            ...
            />
            <a className='mt-2 flex items-center h-[18px] px-3 text-xs text-gray-500' href="https://docs.tiby.ai/features/datasets#how-to-write-a-good-dataset-description" target='_blank' rel='noopener noreferrer'>
          ...
          <div className={cn(rowClass)}>
            ...
            <div className='w-full'>
              ...
              <div className='mt-2 w-full text-xs leading-6 text-gray-500'>
                ...
                <span className='text-[#542cb7] cursor-pointer' onClick={() => setShowAccountSettingModal({ payload: 'provider' })}>{t('datasetSettings.form.embeddingModelTipLink')}</span>
              </div>
            </div>
          </div>
        )}
